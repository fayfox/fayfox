...
class ContactController extends FrontController{
	...
	public function index(){
		...
		$this->layout->title = Option::get('seo_contact_title');
		$this->layout->keywords = Option::get('seo_contact_keywords');
		$this->layout->description = Option::get('seo_contact_description');
