...
-- 两个widget
INSERT INTO `{{$prefix}}widgets` VALUES ('1', 'categories', '{\"hierarchical\":0,\"top\":1000,\"title\":\"\\u5206\\u7c7b\",\"uri\":\"cat\\/{$id}\",\"template\":\"frontend\\/widget\\/categories\"}', 'fayfox/categories', '文章分类列表', '1');
INSERT INTO `{{$prefix}}widgets` VALUES ('2', 'recent_posts', '{\"subclassification\":1,\"top\":1,\"title\":\"\\u8fd1\\u671f\\u6587\\u7ae0\",\"number\":5,\"uri\":\"post\\/{$id}\",\"template\":\"frontend\\/widget\\/recent_posts\",\"date_format\":\"\",\"thumbnail\":0,\"order\":\"publish_time\"}', 'fayfox/category_post', '最新发布', '1');
