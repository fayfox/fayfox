...
class TravelController extends FrontController{
	...
	public function item(){
		...
		$this->view->assign(array(
			...
			'food_posts'=>Recommend::model()->getByCatAndArea($food_cat, 9, Option::get('content_recommend_days'), $area['id']),
			'product_posts'=>Recommend::model()->getByCatAndArea($product_cat, 9, Option::get('content_recommend_days'), $area['id']),
			'right_posts'=>Recommend::model()->getByCatAndArea($product_cat, 6, Option::get('right_recommend_days')),
			'right_top_posts'=>Recommend::model()->getByCatAndArea($travel_cat, 2, Option::get('right_top_recommend_days'), 0, $id),
		))->render();
	}
}