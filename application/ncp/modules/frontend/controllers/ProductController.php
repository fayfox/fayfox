...
class ProductController extends FrontController{
	...
	public function item(){
		...
		$this->view->assign(array(
			...
			'right_posts'=>Recommend::model()->getByCatAndArea($food_cat, 6, Option::get('right_recommend_days')),
			'right_top_posts'=>Recommend::model()->getByCatAndArea($product_cat, 2, Option::get('right_top_recommend_days'), 0, $id),
		))->render();
	}
}