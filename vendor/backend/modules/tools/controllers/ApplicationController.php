...
class ApplicationController extends ToolsController{
	...
	public function create(){
		...
		if($this->input->post()){
			...
			//创建主配置文件
			$config_file = file_get_contents(SYSTEM_PATH.'backend/modules/tools/views/application/_templates/config/main.txt');
			...
			//创建前端控制器基类
			$front_controller = file_get_contents(SYSTEM_PATH.'backend/modules/tools/views/application/_templates/library/FrontController.txt');
			...
			//创建默认控制器
			$index_controller = file_get_contents(SYSTEM_PATH.'backend/modules/tools/views/application/_templates/module/IndexController.txt');
			...
			//创建默认视图
			File::createFile(BASEPATH.'..'.DS.'application/'.$app_name.'/modules/frontend/views/index/index.php', file_get_contents(SYSTEM_PATH.'backend/modules/tools/views/application/_templates/module/index.txt'));
			
			//创建默认layout
			File::createFile(BASEPATH.'..'.DS.'application/'.$app_name.'/modules/frontend/views/layout/frontend.php', file_get_contents(SYSTEM_PATH.'backend/modules/tools/views/application/_templates/module/frontend.txt'));
			
			//创建默认css
			File::createFile(BASEPATH.'static/'.$app_name.'/css/style.css', file_get_contents(SYSTEM_PATH.'backend/modules/tools/views/application/_templates/static/style.css'));
			
			if($this->input->post('database')){
				//安装数据库
				$this->db = new \backend\library\Db(array(
